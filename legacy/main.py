...
ASSETS_PATH = "https://raw.githubusercontent.com/python-backup/sys/refs/heads/master/assets/sys-assets.png"
BACKUPS_PATH = "https://raw.githubusercontent.com/python-backup/sys/refs/heads/master/assets/sys-backups.png"
LOGS_PATH = "https://raw.githubusercontent.com/python-backup/sys/refs/heads/master/assets/sys-logs.png"
AVATAR_PATH = os.path.join(os.getcwd(), "assets", "sys-pfp.png")
    ...
    async def _badge(self, client: CustomTelegramClient):
        ...
        try:
            ...
            await client.legacy_inline.bot.send_animation(
                ...
                caption=(
                    "🌙 <b>Legacy started!</b>\n"
                    '⚙ <b>GitHub commit SHA: <a href="https://github.com/python-backup/sys/commit/{}">{}</a></b>\n'
                    "🔎 <b>Update status: {}</b>\n<b>{}</b>"
                ).format(
                    build,
                    build[:7],
