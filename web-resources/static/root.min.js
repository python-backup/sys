function auth(e) {
    $(".main").fadeOut(250), setTimeout((() => {
        $(".auth").hide().fadeIn(250, (() => {
            ...
            credentials: "include",
            timeout: 25e4
        }).then((e => e.text())).then((t => "TIMEOUT" == t ? (error_message("Code waiting timeout exceeded. Reload page and try again."), void $(".auth").fadeOut(250)) : t.startsWith("legacy_") ? ($.cookie("session", t), auth_required = !1, $(".authorized").hide().fadeIn(100), $(".auth").fadeOut(250, (() => {
